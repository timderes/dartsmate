...
When reporting a bug, please provide as much detail as possible, including the latest logs created by DartsMate. You can find the logs in the following locations:

- **Windows:** `%APPDATA%\DartsMate\logs`
